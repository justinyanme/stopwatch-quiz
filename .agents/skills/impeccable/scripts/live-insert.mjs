...
Output (JSON):
  ...
  // Report the marker line itself, matching live-wrap.mjs. The agent inserts
  // variants below that line so they stay inside the data-impeccable wrapper.
  const insertLine = spliceIndex + 2;
